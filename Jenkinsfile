node{
   ...
   stage('Compile-Package-create-war-file'){
      ...
      bat "C:\WINDOWS\system32\config\systemprofile\AppData\Local\Jenkins\.jenkins\tools\hudson.tasks.Maven_MavenInstallation\apache-maven-3.8.3\bin\mvn package"
      }
